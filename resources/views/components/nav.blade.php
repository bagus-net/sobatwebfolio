<nav class="container max-w-[1130px] mx-auto flex justify-between items-center pt-[30px] z-10">
    ...
    <div class="flex gap-[50px] items-center">
        ...
        <button class="bg-portto-light-gold font-bold text-lg p-[14px_30px] rounded-full transition-all duration-300 hover:shadow-[0_10px_20px_0_#FFE7C280] hire-me-button">Hire Me</button>
    </div>
</nav>
